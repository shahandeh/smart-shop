...
class RemoteDataSource @Inject constructor(
    ...
    override suspend fun createOrder(customerId: Int, createOrder: CreateOrder) = iShopApi.createOrder(customerId, createOrder)

    override suspend fun addToOrder(id: Int, createOrder: CreateOrder) = iShopApi.addToOrder(id, createOrder)

    override suspend fun updateOrder(id: Int, updateOrder: UpdateOrder) = iShopApi.updateOrder(id, updateOrder)
    ...
    override suspend fun createUser(createCustomer: CreateCustomer) = iShopApi.createUser(createCustomer)
